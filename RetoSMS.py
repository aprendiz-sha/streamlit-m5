...
graf_horas_genero= px.bar(horasGenero, y="average_work_hours", labels={"gender": "Género","average_work_hours": "Horas promedio"})
...
desempeño_horas=px.scatter(df, y="average_work_hours", x="performance_score", size="salary")
